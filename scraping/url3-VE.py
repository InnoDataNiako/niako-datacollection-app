...
# URL base pour vêtements enfants
base_url = "https://sn.coinafrique.com/categorie/vetements-enfants?page="
headers = {
...
for page in range(1, nb_pages + 1):
    ...
    for card in cards:
        try:
            type_habit = card.find("p", class_="ad__card-description").get_text(strip=True)
...
df.to_csv("vetements_enfants.csv", index=False)
print(df.head())
